...
let selectedValue = 200;  // Valor predeterminado
...
async function cargarDatos() {
  try {
    const resp = await fetch("https://datosinversor2.azurewebsites.net/api/dashboard?tz=-3");
...
async function update() {
  ...
  // fill header meta
    ...
    if(!ppvpcwChart){
      ...
      ppvpcwChart.data.datasets[2].data = carga;
